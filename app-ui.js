/* Anaesthetic Night Roster V37.26 interface, staffing, allocation and PWA features. */
...
function onboardingChatPage(){
  return '<div class="onboardingVisual chatOnboardingVisual" aria-hidden="true"><span class="chatOnboardingIcon">'+interfaceIcon('chat')+'</span><div class="chatOnboardingLines"><i></i><i></i><i></i></div></div><span class="onboardingEyebrow">Chat</span><h2 id="onboardingTitle">Keep roster conversations together.</h2><p>Anaesthetic Team is the shared chat for roster matters. You can also message a registered roster colleague privately.</p><div class="onboardingFeatureList"><div><b>Team</b><span>Ask the group about tonight, availability or a possible swap</span></div><div><b>Private</b><span>Message a registered roster colleague one-to-one</span></div><div><b>Alerts</b><span>Optional notifications tell you when a new message arrives</span></div></div><p class="onboardingFootnote">Chat is for staff coordination only. Do not share patient-identifiable or clinical information.</p>';
}
...
function onboardingPages(){
  ...
  return[
    ...
    '<div class="onboardingVisual readyVisual" aria-hidden="true"><span>'+interfaceIcon('task')+'</span></div><span class="onboardingEyebrow">Ready</span><h2 id="onboardingTitle">That’s all you need to start.</h2><p>Open Night for tonight’s plan, Changes when something genuinely changes, Breaks for the current arrangement and Chat for team coordination.</p><div class="onboardingCallout"><b>More options live in Account</b><span>You can add a profile photo, preferred name or passkey later without holding up setup.</span></div>'
  ];
}
