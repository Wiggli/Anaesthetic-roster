/* Anaesthetic Night Roster V35.1 interface, staffing, allocation and PWA features. */
...
function updateChangesWorkflow(base,plan){
  ...
  byId('continueToAllocationBtn').textContent=tasks?taskInstruction:'Review roles';
  var confirmButton=byId('continueToConfirmBtn');confirmButton.disabled=!!tasks;confirmButton.classList.toggle('hidden',!confirmNeeded);confirmButton.textContent=tasks?taskInstruction:'Review changes';
