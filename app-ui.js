...
var RELEASE_HISTORY=[
  {version:'37.16',date:'24 Sep 2026',title:'More ways to sign in',changes:['Approved roster members can sign in with Google or Microsoft once those providers are enabled in Supabase.','Microsoft sign-in requests the email scope required by Supabase, and both providers return to the existing Night Roster URL after authentication.','The existing approved-email check remains the access boundary, so a successful Google or Microsoft login still cannot open the roster unless that email is active in allowed_users.','Email and password, password reset, passkeys, roster calculations, staffing, allocations, Pager, Reliever and database permissions remain unchanged.']},
