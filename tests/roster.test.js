...
assert.match(html, /class="launchMark"[\s\S]*icon-192\.png\?v=37\.34/, 'the cinematic launch must begin with the same app icon used by the installed PWA splash');
