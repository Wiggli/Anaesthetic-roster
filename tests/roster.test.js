...
assert.ok(!navigation.includes('.nightStatusRow,.changesWorkflowTabs,.dateNav,.chatMessageViewport'), 'ordinary Night and Chat surfaces must not remain swipe dead zones');
