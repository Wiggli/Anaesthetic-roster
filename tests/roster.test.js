...
assert.ok(navigation.includes("const blockedContentSelector = 'button,a,input,select,textarea,[role=\"button\"],[contenteditable=\"true\"],[tabindex]';"), 'whole content containers must not be blanket-blocked from starting a page swipe');
