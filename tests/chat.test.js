...
assert.match(ui, /Keep roster conversations together\./, 'chat onboarding must explain the feature in plain language');
assert.match(ui, /If you agree a swap or another change in chat, update the roster separately/, 'chat onboarding must explain that chat never replaces roster updates');
assert.match(ui, /Alerts[\s\S]*Optional notifications tell you when a new message arrives/, 'chat onboarding must introduce optional message notifications');
