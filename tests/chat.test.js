...
assert.match(html, /chat\.css\?v=37\.35/, 'chat styling must be versioned with the app');
assert.match(html, /chat\.js\?v=37\.35/, 'chat client must be versioned with the app');
