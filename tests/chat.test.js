...
assert.match(html, /chat\.css\?v=37\.42/, 'chat styling must be versioned with the app');
assert.match(html, /chat\.js\?v=37\.42/, 'chat client must be versioned with the app');
