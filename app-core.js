...
var APP_VERSION = '37.29';
var EXPECTED_SCHEMA_VERSION = 45;
...
function clearPrivateDeviceData(){['anaes_offline_snapshot','anaes_cached_profile','anaes_recent_overtime_names','anaes_seen_night_activity','anaes_my_name'].forEach(function(key){try{localStorage.removeItem(key)}catch(error){}})}
var toastTimer=null;
