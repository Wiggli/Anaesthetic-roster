const CACHE_NAME = 'anaesthetic-night-roster-v37-5';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=37.5',
  './theme-bootstrap.js?v=37.5',
  './app-core.js?v=37.5',
  './app-ui.js?v=37.5',
  './manifest.webmanifest?v=37.5',
  './release.json',
  './icon-192.png?v=37.5',
  './icon-512.png?v=37.5',
  './icon-maskable-192.png?v=37.5',
  './icon-maskable-512.png?v=37.5',
  './apple-touch-icon.png?v=37.5',
  './anaesthesia-header.jpg?v=37.5',
  './mater-dei-logo.png?v=37.5'
];
