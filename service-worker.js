const CACHE_NAME = 'anaesthetic-night-roster-v37-46';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=37.46',
  './theme-bootstrap.js?v=37.46',
  './app-core.js?v=37.46',
  './app-ui.js?v=37.46',
  './manifest.webmanifest?v=37.46',
  './release.json',
  './icon-192.png?v=37.46',
  './icon-512.png?v=37.46',
  './apple-touch-icon.png?v=37.46',
  './anaesthesia-header.jpg?v=37.46',
  './mater-dei-logo.png?v=37.46'
];
...
self.addEventListener('push', event => {
  event.waitUntil((async () => {
    ...
    const options = {
      ...
      icon: new URL('./icon-192.png?v=37.46', self.registration.scope).href,
      badge: new URL('./icon-192.png?v=37.46', self.registration.scope).href,
