const CACHE_NAME = 'anaesthetic-night-roster-v35-1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=35.1',
  ...
  './icon-192.png?v=35.1',
  './icon-512.png?v=35.1',
  './icon-maskable-192.png?v=35.1',
  './icon-maskable-512.png?v=35.1',
  './apple-touch-icon.png?v=35.1',
  './anaesthesia-header.jpg?v=35.1',
  './mater-dei-logo.png?v=35.1'
];
