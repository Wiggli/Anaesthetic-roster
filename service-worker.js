const CACHE_NAME = 'anaesthetic-night-roster-v34-3';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=34.3',
  ...
  './icon-192.png?v=34.3',
  './icon-512.png?v=34.3',
  './icon-maskable-192.png?v=34.3',
  './icon-maskable-512.png?v=34.3',
  './apple-touch-icon.png?v=34.3',
  './anaesthesia-header.jpg?v=34.3',
  './mater-dei-logo.png?v=34.3'
];
