...
const APP_SHELL = [
  ...
  './app-core.js?v=36.3',
  './app-ui.js?v=36.3',
  './manifest.webmanifest?v=36.3',
  './icon-192.png?v=36.3',
  './icon-512.png?v=36.3',
  './icon-maskable-192.png?v=36.3',
  './icon-maskable-512.png?v=36.3',
  './apple-touch-icon.png?v=36.3',
  './anaesthesia-header.jpg?v=36.3',
  './mater-dei-logo.png?v=36.3'
];
