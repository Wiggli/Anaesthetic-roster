const CACHE_NAME = 'anaesthetic-night-roster-v37-47';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=37.47',
  './theme-bootstrap.js?v=37.47',
  './app-core.js?v=37.47',
  './app-ui.js?v=37.47',
  './manifest.webmanifest?v=37.47',
  './release.json',
  './icon-192.png?v=37.47',
  './icon-512.png?v=37.47',
  './apple-touch-icon.png?v=37.47',
  './anaesthesia-header.jpg?v=37.47',
  './mater-dei-logo.png?v=37.47'
];
...
self.addEventListener('push', event => {
  event.waitUntil((async () => {
    ...
    const options = {
      ...
      icon: new URL('./icon-192.png?v=37.47', self.registration.scope).href,
      badge: new URL('./icon-192.png?v=37.47', self.registration.scope).href,
