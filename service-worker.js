const CACHE_NAME = 'anaesthetic-night-roster-v34-2';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=34.2',
  ...
  './icon-192.png?v=34.2',
  './icon-512.png?v=34.2',
  './icon-maskable-192.png?v=34.2',
  './icon-maskable-512.png?v=34.2',
  './apple-touch-icon.png?v=34.2',
  './anaesthesia-header.jpg?v=34.2',
  './mater-dei-logo.png?v=34.2'
];
