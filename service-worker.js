const CACHE_NAME = 'anaesthetic-night-roster-v37-36';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=37.36',
  './theme-bootstrap.js?v=37.36',
  './app-core.js?v=37.36',
  './app-ui.js?v=37.36',
  './manifest.webmanifest?v=37.36',
  './release.json',
  './icon-192.png?v=37.36',
  './icon-512.png?v=37.36',
  './apple-touch-icon.png?v=37.36',
  './anaesthesia-header.jpg?v=37.36',
  './mater-dei-logo.png?v=37.36'
];
...
self.addEventListener('push', event => {
  event.waitUntil((async () => {
    ...
    const options = {
      ...
      icon: new URL('./icon-192.png?v=37.36', self.registration.scope).href,
      badge: new URL('./icon-192.png?v=37.36', self.registration.scope).href,
