const CACHE_NAME = 'anaesthetic-night-roster-v34-1';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=34.1',
  ...
  './icon-192.png?v=34.1',
  './icon-512.png?v=34.1',
  './icon-maskable-192.png?v=34.1',
  './icon-maskable-512.png?v=34.1',
  './apple-touch-icon.png?v=34.1',
  './anaesthesia-header.jpg?v=34.1',
  './mater-dei-logo.png?v=34.1'
];
