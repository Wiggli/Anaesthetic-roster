...
const APP_SHELL = [
  ...
  './index.html',
  './styles.css?v=37.44',
  './theme-bootstrap.js?v=37.44',
  './app-core.js?v=37.44',
  './app-ui.js?v=37.44',
  './manifest.webmanifest?v=37.44',
  './release.json',
  './icon-192.png?v=37.44',
  './icon-512.png?v=37.44',
  './apple-touch-icon.png?v=37.44',
  './anaesthesia-header.jpg?v=37.44',
  './mater-dei-logo.png?v=37.44'
];
...
self.addEventListener('push', event => {
  event.waitUntil((async () => {
    ...
    const options = {
      ...
      icon: new URL('./icon-192.png?v=37.44', self.registration.scope).href,
      badge: new URL('./icon-192.png?v=37.44', self.registration.scope).href,
