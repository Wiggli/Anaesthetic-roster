const CACHE_NAME = 'anaesthetic-night-roster-v37-30';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=37.30',
  './theme-bootstrap.js?v=37.30',
  './app-core.js?v=37.30',
  './app-ui.js?v=37.30',
  './manifest.webmanifest?v=37.30',
  './release.json',
  './icon-192.png?v=37.30',
  './icon-512.png?v=37.30',
  './apple-touch-icon.png?v=37.30',
  './anaesthesia-header.jpg?v=37.30',
  './mater-dei-logo.png?v=37.30'
];
...
self.addEventListener('push', event => {
  event.waitUntil((async () => {
    ...
    const options = {
      ...
      icon: new URL('./icon-192.png?v=37.30', self.registration.scope).href,
      badge: new URL('./icon-192.png?v=37.30', self.registration.scope).href,
